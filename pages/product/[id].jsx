  ...
  return (
    <div>
      ...
      <ul className="flex border-b">
        <li
          onClick={() => setActiveTab('description')} // Set active tab to 'description'
          className={`text-gray-800 font-semibold text-sm py-3 px-8 cursor-pointer transition-all ${
            activeTab === 'description' ? 'bg-gray-100 border-b-2 border-gray-800' : ''
          }`}
        >
          Description
        </li>
        <li
          onClick={() => setActiveTab('reviews')} // Set active tab to 'reviews'
          className={`text-gray-500 font-semibold text-sm py-3 px-8 cursor-pointer transition-all ${
            activeTab === 'reviews' ? 'bg-gray-100 border-b-2 border-gray-800' : ''
          }`}
        >
          Reviews
        </li>
      ...
      <div className="mt-8">
        {activeTab === 'description' ? (
          ...
          <div className="text-sm text-gray-500 mt-4">
            {/* Placeholder content for Reviews tab */}
            <p>No reviews yet.</p>
          </div>
        )}
      </div>
